...
<head runat="server">
    ...
    <script type="text/javascript">
        function tb1_OnKeyUp(s, e) {
            ...
            var caretPosition = s.GetInputElement().selectionStart;
            if (code > 40 || code < 37)
...
<body>
    <form id="form1" runat="server">
        <table>
            <tr>
                <td>
                    <dx:ASPxLabel ID="lbl1" runat="server" Text="A solution based on the client-side event:"></dx:ASPxLabel>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <dx:ASPxLabel ID="lbl2" runat="server" Text="A solution based on MaskSettings:"></dx:ASPxLabel>
                </td>
                <td>
